...
public class MainSemaphore {
  ...
  public static void main(String[] args) {
    ...
    try {
      file = new FileWriter("C:\\Users\\clah\\eclipse-workspace\\Atividade-Concorrente-Relatorio\\results\\semaphore.csv", true);
    ...
    while (run < runTotal) {
      ...
      SemaphoreCounter counter = new SemaphoreCounter(0);

      for (int i = 0; i < numberOfThreads; i++) {

        Runnable r = new SemaphoreThread(i, counter, counterCalls);
