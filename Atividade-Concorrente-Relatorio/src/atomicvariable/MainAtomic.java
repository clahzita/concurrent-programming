...
public class MainAtomic {
  ...
  public static void main(String[] args) {
    ...
    try {
      file = new FileWriter("C:\\Users\\clah\\eclipse-workspace\\Atividade-Concorrente-Relatorio\\results\\atomicvariable.csv", true);
    ...
    while (run < runTotal) {
      ...
      for (int i = 0; i < numberOfThreads; i++) {
        ...
        Runnable r = new AtomicThread(i, counter, counterCalls);
