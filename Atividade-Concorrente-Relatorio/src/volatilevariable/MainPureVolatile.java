...
public class MainPureVolatile {
  ...
  public static void main(String[] args) {
    ...
    try {
      file = new FileWriter("C:\\Users\\clah\\eclipse-workspace\\Atividade-Concorrente-Relatorio\\results\\purevolatilevariable.csv", true);
    ...
    while (run < runTotal) {
      ...
      PureVolatileCounter counter = new PureVolatileCounter(0);

      for (int i = 0; i < numberOfThreads; i++) {

        Runnable r = new PureVolatileThread(i, counter, counterCalls);
